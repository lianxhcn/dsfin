...
#### 二元变量 (Binary Variables) {.unnumbered}
...
#### 多项类别变量 (Multinomial Variables) {.unnumbered}
...
#### 有序变量 (Ordered Variables) {.unnumbered}
...
#### 非负变量 (Non-negative Variables) {.unnumbered}
...
#### 截断变量 (Truncated Variables) {.unnumbered}
...
#### 归并变量 (Censored Variables) {.unnumbered}
...
#### 计数变量 (Count Variables) {.unnumbered}
