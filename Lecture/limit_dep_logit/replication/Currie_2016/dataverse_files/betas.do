...
log using ${logdir}betas.log, replace
...
forvalues x=1(1)13 {;
guse ${datadir2}ip_betas_`x'000_ami_er.dta;
su;
...
save ${datadir2}ip_betas_`x'000s_ami_er.dta, replace;
clear; 
};
...
use ${datadir2}ip_betas_1000s_ami_er.dta;
forvalues x=2(1)13 {;
append using ${datadir2}ip_betas_`x'000s_ami_er.dta;
};
sort sys_recid;
su;
save ${datadir2}ip_betas_ami_1_13000_er.dta, replace;
...
sort sys_recid;
merge sys_recid using ${datadir2}ip_betas_ami_1_13000_er.dta;
tab _merge;
keep if _merge==3;
drop _merge;
...
from 2006-2009;
*For that reason, j`x'_ust code race as white, black, or other;
...
drop pr31_orig dyrqtr dqtr1-age_dheart31 _est_* ll_* temp gapicc_temp N;

*=================================================================================;
*Save clean data set;

gsave ${datadir1}ip_ami_final_er.dta, replace;
