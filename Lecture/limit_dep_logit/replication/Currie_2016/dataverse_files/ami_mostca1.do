...
log using ${logdir}ami_mostca1.log, replace
...
keep sys_recid new_id surgery invasive angio
...
and where we keep patients with cardiologist and patients who visit hospitals where at least half of AMI
...
gsave ${datadir2}ip_betas_1000_ami_er_mostca.dta, replace;
